    ...
    ILogger<FeedsController> logger) : Controller
{
    ...
    public async Task<IActionResult> Home(int page = 1, int pageSize = 20)
    {
        var userId = GetCurrentUserId();
        
        // Lấy bài đăng từ tất cả mọi người (giống Post/Index cũ)
        ...
        var viewModel = new PostListViewModel
        {
            ...
            CurrentPage = page,
            PageSize = pageSize,
            ViewType = "home" // Đánh dấu là feed "Home"
        };
